...
from .fibonacci_action_client_node import FibonacciActionClientNode
...
class Ros2ActionTest(Node):
    ...
    def __init__(self, node_name):
        ...
        self.fibonacci_action_client = FibonacciActionClient(self)
        self.fibonacci_action_client_spin_future = FibonacciActionClientSpinFuture(self)
    ...
    def create_thread(self, order):
        ...
        future = self.fibonacci_action_client_spin_future.send_goal(order)
        self.fibonacci_action_client_spin_future.get_result(future)
    ...
    def test(self):
         ...
         """
         while rclpy.ok():
            self.fibonacci_action_client.send_goal(2)
